                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body printableArea">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: pre-line;"><b>Descripción:</b> {{$tarea->descripcion}}
                                                ...
                                                <b>Tipo de Actividad: </b><span class='text-info'><b>@if($tarea->tipo == 1) Urgente @endif @if($tarea->tipo == 2) Preventiva @endif @if($tarea->tipo == 3) Normal @endif </b></span>
                                            ...
                                            <td style="text-align: center;">
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu animated bounce" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 35px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                        ...
                                                        <a class="dropdown-item" data-toggle="modal" data-target="#exampleModal-rep-{{$tarea->id}}" href="javascript:void(0)">Reprogramar</a>
                                            ...
                                            @for ($i = 1; $i <= $maximo ; $i++) @if(($i>= $tarea->f_inicio) && ($i<= $tarea->f_fin))
                                                    ...
                                                    <td whith="5px" style="text-align: center;"> <span class="label" style="background: {{$tarea->color}};">X</span> <br>
                                                        @foreach($reprogramacion as $prog)
                                                        @if($prog->id_tarea == $tarea->id)
                                                        @if(($i>= $prog->f_inicio) && ($i<= $prog->f_fin))
                                                            <span class="label" style="background: {{$prog->color}};">X</span>
                                                            @endif
                                                            @endif
                                                            @endforeach
                                                    </td>
                                                    @else
                                                    <td whith="5px">
                                                    <span class="label" style="background: #ffffff;"></span>
                                                        @foreach($reprogramacion as $prog)
                                                        @if($prog->id_tarea == $tarea->id)
                                                        @if(($i>= $prog->f_inicio) && ($i<= $prog->f_fin))
                                                            <br><span class="label" style="background: {{$prog->color}};">X</span>
                                                            @else
                                                            <span class="label" style="background: #ffffff;"></span>
                                                        ...
                                                        <div class="row p-t-20">
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" name="descripcion" id="message-text1" required></textarea>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="recipient-name" class="control-label">Lider del proyecto:</label>
                                                                    <input type="text" name="lider_proyecto" class="form-control" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="recipient-name" class="control-label">Materiales:</label>
                                                                    <textarea class="form-control" name="materiales" id="message-text1" required></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <select class="form-control form-control-line" name="estatus" required>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-12">Tipo de Actividad</label>
                                                                    <div class="col-sm-12">
                                                                        <select class="form-control form-control-line" name="tip_tar" required>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="f_inicio" min="1" max="{{$maximo}}" class="form-control" required>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="recipient-name" class="control-label">Fin:</label>
                                                                    <input type="number" name="f_fin" min="1" max="{{$maximo}}" class="form-control" required>
                                                                </div>
                                                                <div class="form-group">
                                                        ...
                                                        <div class="row p-t-20">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-12">Tipo de Actividad</label>
                                                                    <div class="col-sm-12">
                                                                        <select class="form-control form-control-line" name="tip_tar">
                                                                            <option value="1" @if($tarea->tipo == 1) {{"selected"}}@endif>Urgente</option>
                                                                            <option value="2" @if($tarea->tipo == 2) {{"selected"}}@endif>Preventiva</option>
                                                                            <option value="3" @if($tarea->tipo == 3) {{"selected"}}@endif>Normal</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                ...
                                <!-- Modal Edit---------->
                                @foreach($tareas as $tarea)
                                <div class="modal fade" id="exampleModal-rep-{{$tarea->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
                                    <div class="modal-dialog modal-lg " role="document">
                                        <div class="modal-content ">
                                            <div class="modal-header bc-colored bg-danger">
                                                <h4 class="modal-title" id="exampleModalLabel1">Reprogramar tarea: {{$tarea->nombre}}</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            </div>
                                            <div class="modal-body">
                                                <form action="{{route('tarea/reprogramar')}}" method="POST">
                                                    @csrf
                                                    <input hidden type="text" name="tarea" value="{{$tarea->id}}" class="form-control">
                                                    <input hidden type="text" name="dg" value="{{$dg}}" class="form-control">
                                                    <input hidden type="text" name="fill" value="si" class="form-control">
                                                        ...
                                                        <div class="row p-t-20">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control" name="motivo" id="message-text1" required></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
